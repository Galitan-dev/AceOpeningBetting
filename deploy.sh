...
bash -c "curl $BASE_URL'/sendMessage?text=🟢 Le bot démarre \!&chat_id=-1001598334230'"
...
_term() {
    ...
    bash -c "curl $BASE_URL'/sendMessage?text=🔴 Le bot a été arrêté \!&chat_id=-1001598334230'"
